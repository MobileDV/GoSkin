 ...
 * Transition effects.
 */
public class TermsFragment extends CustomFragment
{
			...
			Bundle savedInstanceState)
	{
		...
		GoSkinCareApplication.getInstance().trackingScreenView(Constant.GA_SCREENNAME_TERMS_OF_USE);
	...
	void setUI() {
		...
		webView.loadUrl(Constant.TermsPageUrl);
	}
